...
CREATE TABLE IF NOT EXISTS `seats` (
  ...
  KEY `room_id` (`room_id`),
  KEY `cinema_id` (`cinema_id`)
) ENGINE=MyISAM AUTO_INCREMENT=371 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Déchargement des données de la table `seats`
--

INSERT INTO `seats` (`id`, `room_id`, `cinema_id`, `seat_number`, `reserved`, `is_accessible`) VALUES
(1, 5, 3, '01', 1, 1),
(2, 5, 3, '02', 1, 1),
(3, 5, 3, '03', 1, 0),
(4, 5, 3, '04', 0, 0),
